...
const REPAIR_SERVICES = [
  {
    icon: Monitor,
    title: "Screen Repair",
    desc: "Cracked or broken screen replacement",
    price: "From $49",
    time: "30 min",
    color: "bg-blue-500",
  },
  {
    ...
    desc: "New battery for extended life",
    price: "From $29",
    time: "20 min",
    color: "bg-green-500",
  },
  {
    icon: Droplets,
    title: "Water Damage",
    desc: "Liquid damage repair & recovery",
    price: "From $59",
    time: "1-2 hrs",
    color: "bg-cyan-500",
  },
  {
    ...
    desc: "Component-level board repair",
    price: "From $79",
    time: "2-4 hrs",
    color: "bg-purple-500",
  },
  {
    icon: Wifi,
    title: "Charging Port",
    desc: "Port cleaning or replacement",
    price: "From $39",
    time: "30 min",
    color: "bg-orange-500",
  },
  {
    icon: HardDrive,
    title: "Data Recovery",
    desc: "Recover lost files and data",
    price: "From $49",
    time: "1-3 hrs",
    color: "bg-red-500",
  },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-br from-[#1a1f3a] via-[#1a2550] to-[#0c1a3a] text-white py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            Fast, reliable repairs with genuine parts. Most fixes completed in
            under 30 minutes. All repairs come with a 90-day warranty.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        {/* Services Grid */}
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-[#1a1f3a] mb-2 text-center">
            Our Repair Services
          </h2>
          <p className="text-gray-500 text-center mb-8">
            Professional repairs for all major brands
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {REPAIR_SERVICES.map((service, i) => (
              <div
                key={i}
                className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-lg hover:border-cyan-200 transition-all group cursor-pointer"
                onClick={() =>
                  setFormData({ ...formData, issue_type: service.title })
                }
              >
                <div
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <h2 className="text-2xl font-bold text-[#1a1f3a] mb-2">
              Book a Repair
            </h2>
